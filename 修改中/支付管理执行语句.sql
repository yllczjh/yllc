...
CREATE TABLE 支付管理_参数种类(
    ...
    更新时间 DATE,
    删除标志 VARCHAR2(50),
    CONSTRAINT PK_支付管理_参数种类 PRIMARY KEY (支付类型,接口名称,参数编码)
);

COMMENT ON COLUMN 支付管理_参数种类.支付类型 IS '支付类型';
COMMENT ON COLUMN 支付管理_参数种类.接口名称 IS '接口名称';
COMMENT ON COLUMN 支付管理_参数种类.参数编码 IS '参数编码';
COMMENT ON COLUMN 支付管理_参数种类.参数名称 IS '参数名称';
COMMENT ON COLUMN 支付管理_参数种类.默认值 IS '默认值';
COMMENT ON COLUMN 支付管理_参数种类.备注 IS '备注';
COMMENT ON COLUMN 支付管理_参数种类.更新时间 IS '更新时间';
COMMENT ON COLUMN 支付管理_参数种类.删除标志 IS '删除标志';




INSERT INTO 支付管理_参数种类
  (支付类型,
   接口名称,
   参数编码,
   参数名称,
...
update 支付管理_参数种类 set 支付类型='微信' where 支付类型='1';
update 支付管理_参数种类 set 支付类型='支付宝' where 支付类型='2';
update 支付管理_参数种类 set 支付类型='银联' where 支付类型='3';
update 支付管理_参数种类 set 支付类型='其他' where 支付类型='4';
update 支付管理_参数种类 set 支付类型='网上支付' where 支付类型='100';
