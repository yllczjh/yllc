...
namespace 业务管理.数据库
{
    public class Db_Common
    {
        ...
        private static IDbHelper dbHelper_体检接口 = null;
        /// <summary>
        ///  连接其他接口数据库使用此方法
        /// </summary>
        /// <param name="db_类型"></param>
        /// <param name="Constring"></param>
        /// <returns></returns>
        public static IDbHelper Get_DbHelper(Db_类型 db_类型, string Constring)
        {
            ...
            {
                case Db_类型.SQL:
                    dbHelper_体检接口 = new MsSqlHelper(Constring);
                    break;
                case Db_类型.Oracle:
                   // dbHelper_体检接口 = new OracleHelper_Interface(Constring);
                    break;
                case Db_类型.Access:
                   // dbHelper_体检接口 = new AccessHelper_Interface();
                    break;
                default:
                    dbHelper_体检接口 = new OracleHelper_Interface();
                    break;
            }


            return dbHelper_体检接口;
        }
