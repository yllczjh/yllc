CREATE OR REPLACE PROCEDURE PR_病案首页西医_季报(STR_参数          IN VARCHAR2,
...
BEGIN
  ...
  BEGIN
    ...
    DELETE FROM 临时表_病案首页西医_季报;

    --更新基本信息
    INSERT INTO 临时表_病案首页西医_季报
      (住院病历号,
       USERNAME, --机构名称
       YLFKFS, --付款方式
       JKKH, --健康卡号
  ...
  FOR ROW_诊断记录 IN CUR_诊断记录 LOOP
    ...
    IF ROW_诊断记录.诊断类型 = '出院诊断' THEN
      STR_SQL := 'UPDATE 临时表_病案首页西医_季报 SET ZYZD=:1,JBDM=:2,RYBQ=:3 WHERE 住院病历号=:4';
      EXECUTE IMMEDIATE STR_SQL
        USING ROW_诊断记录.疾病名称, ROW_诊断记录.ICD码, ROW_诊断记录.入院病情, ROW_诊断记录.住院病历号;
    ELSIF ROW_诊断记录.诊断类型 = '其他诊断' THEN
      STR_SQL := 'UPDATE 临时表_病案首页西医_季报 SET QTZD' || ROW_诊断记录.RN || '=:1,JBDM' ||
                 ROW_诊断记录.RN || '=:2,RYBQ' || ROW_诊断记录.RN ||
                 '=:3 WHERE 住院病历号=:4';
      EXECUTE IMMEDIATE STR_SQL
        USING ROW_诊断记录.疾病名称, ROW_诊断记录.ICD码, ROW_诊断记录.入院病情, ROW_诊断记录.住院病历号;
    ELSIF ROW_诊断记录.诊断类型 = '损伤和中毒外部原因' THEN
      STR_SQL := 'UPDATE 临时表_病案首页西医_季报 SET WBYY=:1,H23=:2 WHERE 住院病历号=:3';
      EXECUTE IMMEDIATE STR_SQL
        USING ROW_诊断记录.疾病名称, ROW_诊断记录.ICD码, ROW_诊断记录.住院病历号;
    ELSIF ROW_诊断记录.诊断类型 = '病理诊断' THEN
      STR_SQL := 'UPDATE 临时表_病案首页西医_季报 SET BLZD=:1,JBMM=:2 WHERE 住院病历号=:3';
      EXECUTE IMMEDIATE STR_SQL
        USING ROW_诊断记录.疾病名称, ROW_诊断记录.ICD码, ROW_诊断记录.住院病历号;
    END IF;
  END LOOP;
  ...
  FOR ROW_手术记录 IN CUR_手术记录 LOOP
    ...
    STR_SQL := 'UPDATE 临时表_病案首页西医_季报 SET SSJCZBM' || ROW_手术记录.RN ||
  ...
  OPEN CUR_导出_列表信息 FOR
    SELECT T.* FROM 临时表_病案首页西医_季报 T WHERE T.ZYZD!='无费退院';
