...
namespace HisDBLayer
{
    ...
    /// 数据库连接配置信息
    /// </summary>
    public static class DbConfigToDFYB
    {
        //这里先写死
        private readonly static string _ConnectionString = ConfigurationManager.ConnectionStrings["OraConnStringLiaoYuanCity"].ConnectionString;
        private readonly static string _ProviderName = ConfigurationManager.ConnectionStrings["OraConnStringLiaoYuanCity"].ProviderName;
        // private readonly static string _ConnectionString ="Data Source=orcl ;Persist Security Info=True;User ID=fshis;Password=fshis;Unicode=True; ";
    ...
    /// 数据库操作助手
    /// </summary>
    public sealed class BaseEntityerToDFYB
    {   //日志
        ...
        /// 数据提供程序的对象
        /// </summary>
        public static DbProviderFactory Factory = DbProviderFactories.GetFactory(DbConfigToDFYB.ProviderName);
        ...
        /// 默认构造
        /// </summary>
        private BaseEntityerToDFYB()
        {
            ConnectionString = DbConfigToDFYB.ConnectionString;
            ProviderName = DbConfigToDFYB.ProviderName;
            CreateFactory();
        }
        ...
        public BaseEntityerToDFYB(ClientInforMation info)
            : this()
        {
            this.clientInfo = info;
        }

        private static BaseEntityerToDFYB _db = new BaseEntityerToDFYB();

        /// <summary>
        /// 默认构造创建BaseEntityer实例
        /// </summary>
        public static BaseEntityerToDFYB Db
        {
            get
            {
                return new BaseEntityerToDFYB();
            }
        }
   ...
   values('{0}','{1}','{2}',to_date('{3}','yyyy-MM-dd hh24:mi:ss'))";
                ...
                BaseEntityerToDFYB db = new BaseEntityerToDFYB();
