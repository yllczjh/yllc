...
namespace HealthCardWcfService.Tool
{
    public class XmlHelper
    {
        ...
        public static Platform_RefundByHIS_OutParam AnalysisXmlResRefundInfo(string strResXml)
        {
            ...
            outParam.REFUND_ID = root.SelectSingleNode("REQ/REFUND_ID").InnerText;
            return outParam;
        }
        ...
        public static Platform_QueryRegRefund_OutParam AnalysisXmlResQueryRegRefundInfo(string strResXml)
        {
            ...
            strResXml = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>" + strResXml;
            root.LoadXml(strResXml);
            outParam.TOTAL_FEE = root.SelectSingleNode("REQ/TOTAL_FEE").InnerText;
            outParam.REFUND_FEE = root.SelectSingleNode("REQ/REFUND_FEE").InnerText;
            outParam.REFUND_ID = root.SelectSingleNode("REQ/REFUND_ID").InnerText;
            outParam.REFUND_COUNT = root.SelectSingleNode("REQ/REFUND_COUNT").InnerText;
            outParam.REFUND_STATUS = root.SelectSingleNode("REQ/REFUND_STATUS").InnerText;
            outParam.REFUND_DATE = root.SelectSingleNode("REQ/REFUND_DATE").InnerText;
            return outParam;
        }
