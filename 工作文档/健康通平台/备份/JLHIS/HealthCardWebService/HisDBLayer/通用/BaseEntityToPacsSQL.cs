...
namespace HisDBLayer
{
    ...
    /// sql数据库连接配置信息
    /// </summary>
    public static class DbConfigToPascSql
    {
        //这里先写死
        private readonly static string _ConnectionString = ConfigurationManager.ConnectionStrings["SQLConnStringPacs"].ConnectionString;
        private readonly static string _ProviderName = ConfigurationManager.ConnectionStrings["SQLConnStringPacs"].ProviderName;
       /// <summary>
        /// sql连接字符串
        /// </summary>
    ...
    /// </summary>
    public sealed class BaseEntityToPacsSQL
    {   //日志
        ...
        /// sql默认构造
        /// </summary>
        private BaseEntityToPacsSQL()
        {
            ConnectionString = DbConfigToPascSql.ConnectionString;
            ProviderName = DbConfigToPascSql.ProviderName;
            CreateFactory();
        }
        /// <summary>
        /// 需要记录客户端信息
        ...
        public BaseEntityToPacsSQL(ClientInforMation info)
            : this()
        {
            this.clientInfo = info;
        }

        private static BaseEntityToPacsSQL _db = new BaseEntityToPacsSQL();
        /// <summary>
        /// 默认构造创建BaseEntityer实例
        /// </summary>
        public static BaseEntityToPacsSQL Db
        {
            get
            {
                return new BaseEntityToPacsSQL();
            }
        }
   ...
   values('{0}','{1}','{2}',to_date('{3}','yyyy-MM-dd hh24:mi:ss'))";
                ...
                BaseEntityToPacsSQL db = new BaseEntityToPacsSQL();
